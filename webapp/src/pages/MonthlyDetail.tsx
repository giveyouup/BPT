  ...
  return (
    <div className="p-4 md:p-8">
      ...
      <div className="flex items-center gap-2 mb-5 px-3 py-2 bg-amber-900/20 border border-amber-800/40 rounded-lg w-fit">
        ...
        {liveReport.autoSplit ? (
          <>
            <span className="text-xs font-medium text-amber-400 uppercase tracking-wide">Auto-Split Report</span>
            <span className="text-gray-700">·</span>
            <span className="text-xs text-amber-600">Created by splitting a multi-month upload — may not reflect an actual PCR report</span>
          </>
        ) : (
          <>
